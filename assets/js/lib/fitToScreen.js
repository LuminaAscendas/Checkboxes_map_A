...
function resizeApp(){
	if(!begin_entered){
		...
		winWidth = window.innerWidth-58; //retrieve current window width
		winHeight = window.innerHeight;
		console.log(winWidth, appWidth)
		if(winWidth-58 < appWidth || winHeight-58 < appHeight)
        {
			if(winWidth >200) scale = (((winWidth/appWidth)<(winHeight/appHeight))?(winWidth/appWidth):(winHeight/appHeight))-0.10//-0.15; //scaling
